    ...
    <div id="sistem-pkl" class="text-center mb-5" data-aos="fade-up">
        ...
        <div class="row justify-content-center mt-3 mb-3">
            <div class="col-md-3 mb-3 custom-spacing" >
                <a href="{{ route('login') }}" class="btn btn-primary btn-lg w-100 d-flex align-items-center justify-content-center sistem-card custom-shadow" alt="Sistem PKL" style="background-color: #439AC7 !important">
